        ...
        {submitted ? (
          ...
          >
            <input
              ...
              className="h-12 flex-1 rounded-full border-none bg-surface-container-lowest px-4 text-body-md text-on-surface outline-none focus:ring-2 focus:ring-secondary-container"
            />
            <button
              type="submit"
